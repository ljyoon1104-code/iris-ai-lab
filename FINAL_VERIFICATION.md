> 2026-09-21 갱신: 아래 내용은 이전 버전의 검증 기록입니다. 현재 버전은 빌드, 기존 검증, 회귀 테스트 4건, 390px·1280px에서의 8개 영역 자유 이동 및 k-means·회귀·초기화 브라우저 검사를 통과했습니다. 전 기기·전 기능에 대한 전수 검증을 의미하지 않습니다. 최신 명령과 변경 사항은 README의 2026-09-21 항목을 참고하세요.
